...
import OffererSolicitationEventTimeline from "./OffererSolicitationEventTimeline";
import {ConversationViewDTO, ConversationViewDTOFields} from "../../../../types/conversations/conversationData";
...
interface OffererSolicitationRightPanelFirstProps {
    solicitation: SolicitationViewDTO
}


const OffererSolicitationRightPanelFirst = ({solicitation} : OffererSolicitationRightPanelFirstProps) => {
    ...
    return (
        <Stack spacing={2}>
            ...
            <OffererSolicitationEventTimeline solicitationId={solicitation[EntityWithIdFields.Id]}/>
        </Stack>
    );
}
...
export default OffererSolicitationRightPanelFirst