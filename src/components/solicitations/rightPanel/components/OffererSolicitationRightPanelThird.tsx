...
interface OffererSolicitationRightPanelThirdProps {
    solicitation: SolicitationViewDTO
}


const OffererSolicitationRightPanelThird = ({solicitation} : OffererSolicitationRightPanelThirdProps) => {
...
export default OffererSolicitationRightPanelThird