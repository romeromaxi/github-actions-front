...
export const eventColors: Partial<Record<SolicitationEventType, string>> = {
  [SolicitationEventType.NewSolicitation]: blue[400],
  [SolicitationEventType.SolicitationNewFile]: yellow[400],
  [SolicitationEventType.UserAssigned]: green[400],
  [SolicitationEventType.UserAssignedChange]: yellow[400],
};

interface OffererSolicitationEventTimelineProps {
  solicitationId: number
}

function OffererSolicitationEventTimeline({
  solicitationId
}: OffererSolicitationEventTimelineProps) {
                  ...
                  <TimelineItem key={index}>
                    <TimelineOppositeContent sx={{ pr: 0, mt: 0.3 }}>
                      <Typography variant={'subtitle1'}>
                        {event[
                              SolicitationEventViewFields.EventTypeOffererDesc
                            ]}
                      </Typography>
                    </TimelineOppositeContent>
                    <TimelineSeparator>
...
export default OffererSolicitationEventTimeline;
