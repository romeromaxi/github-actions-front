...
interface CompanyLibraryResponsibleProps {
  companyId: number;
}

function CompanyLibraryResponsible(props: CompanyLibraryResponsibleProps) {
  ...
  const columns: ITableColumn[] = [
    ...
    { label: 'Responsable', value: PeopleDocumentFields.BusinessName },
  ...
  const searchDocuments = useCallback(() => {
    ...
    setLoading(true);
    HttpFilesCompanySearch.searchResponsibles(props.companyId, libraryFilter)
      .then((r) => {
        setFilesPerson(r);
  ...
  const loadRelatedPeople = () => {
    HttpCompanyRelationship.getRelationshipResponsibles(props.companyId).then(
      (r) => {
...
export default CompanyLibraryResponsible;
