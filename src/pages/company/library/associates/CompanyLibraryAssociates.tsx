...
interface CompanyLibraryAssociatesProps {
  companyId: number;
}

function CompanyLibraryAssociates(props: CompanyLibraryAssociatesProps) {
  ...
  const columns: ITableColumn[] = [
    ...
    { label: 'Socio', value: PeopleDocumentFields.BusinessName },
  ...
  const searchDocuments = useCallback(() => {
    ...
    setLoading(true);
    HttpFilesCompanySearch.searchAssociates(props.companyId, libraryFilter)
      .then((r) => {
        setFilesPerson(r);
  ...
  const loadRelatedPeople = () => {
    HttpCompanyRelationship.getRelationshipSocieties(props.companyId).then(
      (r) => {
...
export default CompanyLibraryAssociates;
