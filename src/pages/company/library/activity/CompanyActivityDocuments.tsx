...
interface CompanyActivityDocumentsProps {
  isPhyisicalPerson?: boolean;
  companyId: number;
}

const CompanyActivityDocuments = ({
  companyId,
}: CompanyActivityDocumentsProps) => {
  ...
  useEffect(() => {
    Promise.all([
      HttpCacheFiles.getTypesBySection(Sections.Activity),
  ...
  const searchDocuments = useCallback(() => {
    ...
    HttpFilesCompanySearch.searchActivities(companyId, libraryFilter)
      .then((r) => {
        setFilesCompany(r);
        setLoading(false);
...
export default CompanyActivityDocuments;
