...
interface CompanyCertificationEditTableIncomesProps {
  nameBase: string;
}
...
const CompanyCertificationEditTableIncomes = ({
  nameBase,
}: CompanyCertificationEditTableIncomesProps) => {
  const { control } = useFormContext();

  const columns: ITableColumn[] = [
    {
      label: 'Total anual',
      value: CompanyCertificationsFields.IncomeAnnual_Total,
      total: true,
    },
  ];
...
export default CompanyCertificationEditTableIncomes;
