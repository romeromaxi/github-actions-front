...
interface CompanySolicitationAssessmentCenterPanelProps {
  solicitation: SolicitationViewDTO;
}

function CompanySolicitationAssessmentCenterPanel({
  solicitation,
}: CompanySolicitationAssessmentCenterPanelProps) {
...
export default CompanySolicitationAssessmentCenterPanel;
