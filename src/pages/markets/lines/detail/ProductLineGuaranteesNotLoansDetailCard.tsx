...
const ProductLineGuaranteesNotLoansDetailCard: FC<
  ProductLineChildrenDetailCardProps
> = ({ productLine }) => {
    ...
    <ProductLineDetailCardBase productLine={productLine}>
      ...
      <Grid item xs={12}>
        <DataWithLabel
          label="Suscripción"
          data={numberFormatter.toStringWithAmount(
            productLine[ProductLineFields.Subscription] || null,
            codCurrency,
          )}
        />
      </Grid>
      <Grid item xs={12}>
        <DataWithLabel
          label="Porc. Cobertura Aval"
          data={
            productLine[ProductLineFields.CoverageGuarantee]
              ? `${productLine[ProductLineFields.CoverageGuarantee]}%`
              : textUnspecified
          }
        />
...
export default ProductLineGuaranteesNotLoansDetailCard;
